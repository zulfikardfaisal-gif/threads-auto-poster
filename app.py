...
def extract_and_parse_json(raw_str: str):
    """Sanitizer untuk mengekstrak dan mem-parse output JSON dari AI"""
...
def generate_bulk_single_product_threads(product_name: str, product_notes: str, affiliate_link: str, style_choice: str, length_choice: str, reply_count: int, count: int = 5) -> list:
    ...
    prompt = (
        f"Bertindaklah sebagai Copywriter Top Tier spesialis Threads Indonesia & Shopee Affiliate.\n"
        ...
        f"WAJIB Format JSON murni (List of Objects), tanpa teks pengantar atau markdown wrapper:\n"
        f'[\n'
        f'  {{\n'
        f'    "angle": "Sudut Pandang / Variasi",\n'
        f'    "main_text": "Teks post utama hook ({len_inst})",\n'
        f'    "replies": ["Teks balasan 1 ({len_inst})", "Teks balasan 2 ({len_inst})"]\n'
        f'  }}\n'
        f']'
    )
...
def generate_curated_listicle_thread(curation_topic: str, items: list, length_choice: str) -> dict:
    ...
    prompt = (
        f"Bertindaklah sebagai Copywriter Top Tier spesialis Threads Indonesia.\n"
        ...
        f"WAJIB Format JSON murni tanpa markdown wrapper:\n"
        f'{{\n'
        f'  "main_text": "...",\n'
        f'  "replies": [\n'
        f'    "Ulasan Item 1...\\n\\n👉 Link Shopee: ...",\n'
